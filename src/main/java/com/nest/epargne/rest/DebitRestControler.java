...
public class DebitRestControler {
	...
	public Reponse getDebits(
			...
			@RequestParam(required = false)  Long date_operation_fin,
	...
	)
	{
		...
		Reponse	credits =debitService.getAllDebits(date_operation,date_operation_fin,montant,motif,size,page);
	...
	)
	{
		...
		Reponse	credits =debitService.getAllDebitsByPatients(date_operation,date_operation_fin,montant,patientID,motif,size,page);
	...
	)
	{
		...
		Reponse	credits =debitService.getAllDebitsByProfessionnels(date_operation,date_operation_fin,montant,professionnalID,motif,size,page);
