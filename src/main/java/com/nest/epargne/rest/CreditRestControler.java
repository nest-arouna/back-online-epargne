...
public class CreditRestControler {
	...
	)
	{
		...
		Reponse	credits =creditService.getAllCreditsByAdminCaisse(date_operation,date_operation_fin,montant,patientID,identifiant_credit,size,page);
	...
	)
	{
		...
		Reponse	credits =creditService.getAllCredits(date_operation,date_operation_fin,montant,creditID,identifiant_credit,size,page);
