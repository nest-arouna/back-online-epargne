...
public class DebitService implements IDebitService{
    ...
    @Override
    public Reponse getAllDebitsByPatients(Long date_operation,Long date_operation_fin, Double montant, UUID patientID, String motif, int size, int page) {
        ...
        try
        {
            ...
            if(credits.size() > 0)
            {
                ...
                long numb_credits =credits
                        .stream()
                        .filter(v ->date_operation == null || (date_operation != null && date_operation.longValue() >0 &&  v.getDateOperation().longValue() >= date_operation.longValue()))
                        .filter(v ->date_operation_fin == null || (date_operation_fin != null && date_operation_fin.longValue() >0 && ((date_operation_fin.longValue()+24*60*60*1000) > v.getDateOperation().longValue()) ))
                ...
                datas.put("totalCredits",numb_credits);
    ...
    @Override
    public Reponse getAllDebitsByProfessionnels(Long date_operation,Long date_operation_fin, Double montant, UUID professionnalID, String motif, int size, int page) {
        int skipCount = (page - 1) * size;
        Reponse reponse = new Reponse();
        try
        {
    ...
    @Override
    public Reponse getAllDebits(Long date_operation,Long date_operation_fin, Double montant, String motif, int size, int page) {
        int skipCount = (page - 1) * size;
        Reponse reponse = new Reponse();
