...
public class CreditService implements ICreditService{
    ...
    @Override
    public Reponse getAllCreditsByAdminCaisse(Long date_operation,Long date_operation_fin, Double montant, UUID patientID, String identifiant_credit, int size, int page) {
        ...
        try
        {
            ...
            if(credits.size() > 0)
            {
                ...
                List<CreditDtoResponse> creditFiltereds =credits
                        .stream()
                        .sorted(Comparator.comparing(Credit::getDateOperation).reversed())
    ...
    @Override
    public Reponse getAllCredits(Long date_operation,Long date_operation_fin, Double montant, UUID patientID, String identifiant_credit, int size, int page) {
        int skipCount = (page - 1) * size;
        Reponse reponse = new Reponse();
        try
        {
