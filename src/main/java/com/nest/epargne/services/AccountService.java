...
public class AccountService implements IAccountService {
	...
	public Reponse getAllProfesionnals(String lastname, String firstname, String adress, String email,String typeOfUser,String phone,Long birthDay,
							...
							int page)
	 {
		...
		try
		{
			...
			{
				queryInit +="AND ( UPPER(c.lastname) LIKE '" +lastname +"%' OR  LOWER(c.lastname) LIKE '" +lastname +"%' OR c.lastname LIKE '" +lastname +"%' )";
			}
			if(firstname != null && firstname.length() != 0)
			{
				queryInit +="AND ( UPPER(c.firstname) LIKE '" +firstname +"%' OR  LOWER(c.firstname) LIKE '" +firstname +"%' OR c.firstname LIKE '" +firstname +"%' )";
			}
			if(adress != null && adress.length() != 0)
			{
				queryInit +="AND ( UPPER(c.adress) LIKE '" +adress +"%' OR  LOWER(c.adress) LIKE '" +adress +"%' OR c.adress LIKE '" +adress +"%' )";

			}

			if(email != null && email.length() != 0)
			{
				queryInit +="AND ( UPPER(c.email) LIKE '" +email +"%' OR  LOWER(c.email) LIKE '" +email +"%' OR c.email LIKE '" +email +"%' )";
			}
			...
			{
				queryInit +="AND ( UPPER(c.identification_code) LIKE '" +identification_code +"%' OR  LOWER(c.identification_code) LIKE '" +identification_code +"%' OR c.identification_code LIKE '" +identification_code +"%' )";
			}
	...
	public Reponse getAllPatients(String assurance,String lastname, String firstname, String adress, String email, String typeOfUser, String phone, Long birthDay, String role, String identification_code, int size, int page) {
		...
		try
		{
			...
			{
				queryInit +="AND ( UPPER(c.assurance) LIKE '" +assurance +"%' OR  LOWER(c.assurance) LIKE '" +assurance +"%' OR c.assurance LIKE '" +assurance +"%' )";
